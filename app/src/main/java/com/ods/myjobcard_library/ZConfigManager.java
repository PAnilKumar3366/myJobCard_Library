...
public class ZConfigManager extends ConfigManager {
    ...
    public static ZAppSettings.MobileStatus WO_ACTIVE_STATUS_DISABLED = ZAppSettings.MobileStatus.ENRT;
    ...
    * */
    ...
    public static boolean TEMP_CHECKSHEET_NEW_FEILDS_ENABLED=false;
