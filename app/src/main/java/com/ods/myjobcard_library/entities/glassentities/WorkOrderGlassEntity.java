...
public class WorkOrderGlassEntity implements Serializable {
    ...
    public static WorkOrderGlassEntity getWorkOrder() {
        ...
        workOrderGlassEntity.setMobileObjStatus(workOrder.getStatusDetail().woOprStatus != null ? workOrder.getStatusDetail().woOprStatus.getMobileStatusDesc() : workOrder.getStatusDetail().getStatusCode());
